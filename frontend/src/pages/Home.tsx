        ...
        <div className='flex flex-col items-center justify-center'>
          ...
          <div className='relative w-full max-w-[700px] mx-auto mt-16'>
            ...
            <input
              ...
              className="w-full py-5 px-12 bg-[#1a1a1a] text-white rounded-3xl focus:outline-none focus:ring-2 focus:ring-[#ff3e9a] transition-all duration-300 placeholder-gray-400 text-lg input-glow outline-none hover:outline hover:outline-[#ff3e9a]"
            />
